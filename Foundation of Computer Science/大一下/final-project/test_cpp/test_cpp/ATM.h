...
public:
    ...
    ATM(void) {
        os.open("/Users/jeffrey/Desktop/test_cpp/test_cpp/data/member.txt", std::ios::trunc);
        os.close();
...
void ATM::add_member(void) {
    ...
    os.open("/Users/jeffrey/Desktop/test_cpp/test_cpp/data/member.txt", std::ios::app);
    os << new_member << '\n';
    os.close();
    ...
    os.open("/Users/jeffrey/Desktop/test_cpp/test_cpp/data/" + new_member.name + "_" + new_member.number + ".txt", std::ios::trunc);
    os << record << '\n';
    os.close();
...
void ATM::print(void) {
    os.open("/Users/jeffrey/Desktop/test_cpp/test_cpp/data/member.txt", std::ios::trunc);
    std::for_each(members.begin(), members.end(), [&](const member& data){ os << data << '\n'; });
    os.close();
}
